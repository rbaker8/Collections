...
public final class RichSpliterators
{
    // Suppresses default constructor, ensuring non-instantiability.
    private RichSpliterators() {}
    ...
    public static <T> RichSpliterator<T> emptySpliterator() {
        return (RichSpliterator<T>) EMPTY_SPLITERATOR;
    }

    private static final Spliterator<Object> EMPTY_SPLITERATOR =
            new RichSpliterators.EmptySpliterator.OfRef<>();
     ...
     * @return An empty spliterator
     */
    public static RichSpliterator.OfInt emptyIntSpliterator() {
        return EMPTY_INT_SPLITERATOR;
    }

    private static final RichSpliterator.OfInt EMPTY_INT_SPLITERATOR =
            new RichSpliterators.EmptySpliterator.OfInt();
     ...
     * @return An empty spliterator
     */
    public static RichSpliterator.OfLong emptyLongSpliterator() {
        return EMPTY_LONG_SPLITERATOR;
    }

    private static final RichSpliterator.OfLong EMPTY_LONG_SPLITERATOR =
            new RichSpliterator.EmptySpliterator.OfLong();
     ...
     * @return An empty spliterator
     */
    public static RichSpliterator.OfDouble emptyDoubleSpliterator() {
        return EMPTY_DOUBLE_SPLITERATOR;
    }

    private static final RichSpliterator.OfDouble EMPTY_DOUBLE_SPLITERATOR =
            new RichSpliterators.EmptySpliterator.OfDouble();
    ...
    public static <T> Spliterator<T> spliterator(Object[] array,
        ...
        return new Spliterators.ArraySpliterator<>(Objects.requireNonNull(array),
     ...
     */
    public static RichSpliterator.OfInt spliterator(int[] array,
                                                int additionalCharacteristics) {
        return new RichSpliterators.IntArraySpliterator(Objects.requireNonNull(array), additionalCharacteristics);
    }
     ...
     */
    public static RichSpliterator.OfInt spliterator(int[] array, int fromIndex, int toIndex,
                                                int additionalCharacteristics) {
        checkFromToBounds(Objects.requireNonNull(array).length, fromIndex, toIndex);
        return new RichSpliterators.IntArraySpliterator(array, fromIndex, toIndex, additionalCharacteristics);
    }
    ...
    public static Spliterator.OfLong spliterator(long[] array,
                                                 int additionalCharacteristics) {
        return new Spliterators.LongArraySpliterator(Objects.requireNonNull(array), additionalCharacteristics);
    }
    ...
    public static Spliterator.OfDouble spliterator(double[] array,
                                                   int additionalCharacteristics) {
        return new Spliterators.DoubleArraySpliterator(Objects.requireNonNull(array), additionalCharacteristics);
    }
    ...
    public static <T> Spliterator<T> spliterator(Collection<? extends T> c,
                                                 int characteristics) {
        return new Spliterators.IteratorSpliterator<>(Objects.requireNonNull(c),
                characteristics);
    }
    ...
    public static <T> Spliterator<T> spliterator(Iterator<? extends T> iterator,
                                                 long size,
                                                 int characteristics) {
        return new Spliterators.IteratorSpliterator<>(Objects.requireNonNull(iterator), size,
                characteristics);
    }
    ...
    public static <T> Spliterator<T> spliteratorUnknownSize(Iterator<? extends T> iterator,
                                                            int characteristics) {
        return new Spliterators.IteratorSpliterator<>(Objects.requireNonNull(iterator), characteristics);
    }
    ...
    public static Spliterator.OfInt spliterator(PrimitiveIterator.OfInt iterator,
                                                long size,
                                                int characteristics) {
        return new Spliterators.IntIteratorSpliterator(Objects.requireNonNull(iterator),
    ...
    public static Spliterator.OfInt spliteratorUnknownSize(PrimitiveIterator.OfInt iterator,
                                                           int characteristics) {
        return new Spliterators.IntIteratorSpliterator(Objects.requireNonNull(iterator), characteristics);
    }
    ...
    public static Spliterator.OfLong spliterator(PrimitiveIterator.OfLong iterator,
                                                 long size,
                                                 int characteristics) {
        return new Spliterators.LongIteratorSpliterator(Objects.requireNonNull(iterator),
                size, characteristics);
    }
    ...
    public static Spliterator.OfLong spliteratorUnknownSize(PrimitiveIterator.OfLong iterator,
                                                            int characteristics) {
        return new Spliterators.LongIteratorSpliterator(Objects.requireNonNull(iterator), characteristics);
    }
    ...
    public static Spliterator.OfDouble spliterator(PrimitiveIterator.OfDouble iterator,
                                                   long size,
                                                   int characteristics) {
        return new Spliterators.DoubleIteratorSpliterator(Objects.requireNonNull(iterator),
                size, characteristics);
    }
    ...
    public static Spliterator.OfDouble spliteratorUnknownSize(PrimitiveIterator.OfDouble iterator,
                                                              int characteristics) {
        return new Spliterators.DoubleIteratorSpliterator(Objects.requireNonNull(iterator), characteristics);
    }
...
private abstract static class EmptySpliterator<T, S extends Spliterator<T>, C> {
    ...
    private static final class OfRef<T>
            extends RichSpliterators.EmptySpliterator<T, Spliterator<T>, Consumer<? super T>>
            implements Spliterator<T> {
        OfRef() { }
    }

    private static final class OfInt
            extends RichSpliterators.EmptySpliterator<Integer, Spliterator.OfInt, IntConsumer>
            implements Spliterator.OfInt {
        OfInt() { }
    }

    private static final class OfLong
            extends RichSpliterators.EmptySpliterator<Long, Spliterator.OfLong, LongConsumer>
            implements Spliterator.OfLong {
        OfLong() { }
    }

    private static final class OfDouble
            extends RichSpliterators.EmptySpliterator<Double, Spliterator.OfDouble, DoubleConsumer>
...
static final class ArraySpliterator<T> implements Spliterator<T> {
    ...
    public Spliterator<T> trySplit() {
        ...
        return (lo >= mid)
                ? null
                : new Spliterators.ArraySpliterator<>(array, lo, index = mid, characteristics);
    }
 ...
 */
static final class IntArraySpliterator implements RichSpliterator.OfInt {
    ...
    public OfInt trySplit() {
        ...
        return (lo >= mid)
                ? null
                : new RichSpliterators.IntArraySpliterator(array, lo, index = mid, characteristics);
    }
    ...
    public Comparator<? super Integer> getComparator() {
        if (hasCharacteristics(RichSpliterator.SORTED))
            return null;
        throw new IllegalStateException();
    }
}
 ...
 * elements maintained in an unmodifiable {@code int[]} array.
 */
static final class LongArraySpliterator implements RichSpliterator.OfLong {
 ...
 * elements maintained in an unmodifiable {@code int[]} array.
 */
static final class DoubleArraySpliterator implements RichSpliterator.OfDouble {
    ...
    public DoubleArraySpliterator(double[] array, int origin, int fence, int additionalCharacteristics) {
        ...
        this.index = origin;
        this.fence = fence;
        this.characteristics = additionalCharacteristics | RichSpliterator.SIZED | RichSpliterator.SUBSIZED;
    }
 ...
 * @since 1.8
 */
public abstract static class AbstractSpliterator<T> implements RichSpliterator<T> {
    ...
    protected AbstractSpliterator(long est, int additionalCharacteristics) {
        this.est = est;
        this.characteristics = ((additionalCharacteristics & RichSpliterator.SIZED) != 0)
                ? additionalCharacteristics | RichSpliterator.SUBSIZED
                : additionalCharacteristics;
    }
     ...
     */
    @Override
    public RichSpliterator<T> trySplit() {
        /*
         ...
         * potential speedup.
         */
        RichSpliterators.AbstractSpliterator.HoldingConsumer<T> holder = new RichSpliterators.AbstractSpliterator.HoldingConsumer<>();
        long s = est;
        if (s > 1 && tryAdvance(holder)) {
            ...
            if (est != Long.MAX_VALUE)
                est -= j;
            return new RichSpliterators.ArraySpliterator<>(a, 0, j, characteristics());
        }
        return null;
    }
 ...
 * @since 1.8
 */
public abstract static class AbstractIntSpliterator implements RichSpliterator.OfInt {
    static final int MAX_BATCH = RichSpliterators.AbstractSpliterator.MAX_BATCH;
    static final int BATCH_UNIT = RichSpliterators.AbstractSpliterator.BATCH_UNIT;
    private final int characteristics;
    private long est;             // size estimate
    private int batch;            // batch size for splits
     ...
     */
    @Override
    public RichSpliterator.OfInt trySplit() {
        RichSpliterators.AbstractIntSpliterator.HoldingIntConsumer holder = new RichSpliterators.AbstractIntSpliterator.HoldingIntConsumer();
        long s = est;
        if (s > 1 && tryAdvance(holder)) {
            int n = batch + BATCH_UNIT;
            if (n > s)
            ...
            if (est != Long.MAX_VALUE)
                est -= j;
            return new RichSpliterators.IntArraySpliterator(a, 0, j, characteristics());
        }
        return null;
    }
 ...
 * @since 1.8
 */
public abstract static class AbstractLongSpliterator implements RichSpliterator.OfLong {
    static final int MAX_BATCH = RichSpliterators.AbstractSpliterator.MAX_BATCH;
    static final int BATCH_UNIT = RichSpliterators.AbstractSpliterator.BATCH_UNIT;
    private final int characteristics;
    private long est;             // size estimate
     ...
     */
    @Override
    public RichSpliterator.OfLong trySplit() {
        RichSpliterators.AbstractLongSpliterator.HoldingLongConsumer holder = new RichSpliterators.AbstractLongSpliterator.HoldingLongConsumer();
        long s = est;
        if (s > 1 && tryAdvance(holder)) {
            int n = batch + BATCH_UNIT;
            if (n > s)
            ...
            if (est != Long.MAX_VALUE)
                est -= j;
            return new RichSpliterators.LongArraySpliterator(a, 0, j, characteristics());
        }
        return null;
    }
 ...
 * @since 1.8
 */
public abstract static class AbstractDoubleSpliterator implements RichSpliterator.OfDouble {
    static final int MAX_BATCH = RichSpliterators.AbstractSpliterator.MAX_BATCH;
    static final int BATCH_UNIT = RichSpliterators.AbstractSpliterator.BATCH_UNIT;
    private final int characteristics;
    private long est;             // size estimate
     ...
     */
    @Override
    public RichSpliterator.OfDouble trySplit() {
        RichSpliterators.AbstractDoubleSpliterator.HoldingDoubleConsumer holder = new RichSpliterators.AbstractDoubleSpliterator.HoldingDoubleConsumer();
        long s = est;
        if (s > 1 && tryAdvance(holder)) {
            int n = batch + BATCH_UNIT;
            if (n > s)
            ...
            if (est != Long.MAX_VALUE)
                est -= j;
            return new RichSpliterators.DoubleArraySpliterator(a, 0, j, characteristics());
        }
        return null;
    }
 ...
 * permit limited parallelism.
 */
static class IteratorSpliterator<T> implements RichSpliterator<T> {
    static final int BATCH_UNIT = 1 << 10;  // batch array size increment
    static final int MAX_BATCH = 1 << 25;  // max batch array size;
    ...
    public IteratorSpliterator(Collection<? extends T> collection, int characteristics) {
        ...
        this.it = null;
        this.characteristics = (characteristics & RichSpliterator.CONCURRENT) == 0
                ? characteristics | RichSpliterator.SIZED | RichSpliterator.SUBSIZED
                : characteristics;
    }
    ...
    public IteratorSpliterator(Iterator<? extends T> iterator, int characteristics) {
        ...
        this.characteristics = characteristics & ~(RichSpliterator.SIZED | RichSpliterator.SUBSIZED);
    }
 ...
 * permit limited parallelism.
 */
static final class IntIteratorSpliterator implements RichSpliterator.OfInt {
    static final int BATCH_UNIT = RichSpliterators.IteratorSpliterator.BATCH_UNIT;
    static final int MAX_BATCH = RichSpliterators.IteratorSpliterator.MAX_BATCH;
...
static final class LongIteratorSpliterator implements RichSpliterator.OfLong {
    static final int BATCH_UNIT = RichSpliterators.IteratorSpliterator.BATCH_UNIT;
    static final int MAX_BATCH = RichSpliterators.IteratorSpliterator.MAX_BATCH;
...
static final class DoubleIteratorSpliterator implements RichSpliterator.OfDouble {
    static final int BATCH_UNIT = RichSpliterators.IteratorSpliterator.BATCH_UNIT;
    static final int MAX_BATCH = RichSpliterators.IteratorSpliterator.MAX_BATCH;
